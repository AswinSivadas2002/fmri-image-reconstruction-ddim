...
#export PYTHONPATH="${PYTHONPATH}:/home/aswin/Downloads/caffe-fr-chairs-deepsim/caffe-fr-chairs-deepsim/python"
#source ~/.bashrc
...
data_table = [
    {
        ...
        'generator_caffemodel': './net_trained/sub-01/generator.caffemodel',
        'generator_prototxt': './net_trained/sub-01/generator_test.prototxt',
...
'''
    {
        ...
        'generator_caffemodel': './net_trained/sub-02/generator.caffemodel',
        'generator_prototxt': './net_trained/sub-02/generator_test.prototxt',
    ...
    },
    {
        ...
        'generator_caffemodel': './net_trained/sub-03/generator.caffemodel',
        'generator_prototxt': './net_trained/sub-03/generator_test.prototxt',
...
# Generator settings
input_layer = 'feat'      # input layer of the generator
output_layer = 'deconv0'  # output layer of the generator
...
img_size = (227, 227, 3)  # size of the reconstructed image during model training 
...
for dat in data_table:
    ...
    for lb in labels_set:
        ...
        # Convert stimulus ID to file name
